        ...
        <Row className="dmpassData">
          <form>
            ...
            <div className="form-group">
              ...
              <input type="text" className="form-control pass_input" id="inputAddress" placeholder="Enter mobile number" />
            </div>
            <div className="form-row">
              <div className="form-group ">
              ...
              <div className="card w-100">
                ...
                />
                      ...
                      <div className="col m-2 w-50">
                        ...
                        <input type="text" className="form-control pass_input w-70 pt-2" placeholder="Enter Age" style={{fontSize:"12px",whiteSpace:"nowrap",height:"33px"}}/>
                      </div>
                    </div>
            ...
            <div className="form-group passengerbtn">
              <button type="submit" className="btn btn-success">Add passenger</button>
            </div>
          </form>
        </Row>
      </Container>
      <div className="payment-div text-center pt-2 bg-warning">
        <h1 >MAKE PAYMENT</h1>
