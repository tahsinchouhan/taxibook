    ...
    <>
      ...
      <div fluid className="d-md-none">
       ...
       <Container>
        ...
        <span style={{fontFamily:"sans-serif",fontWeight:"bold"}}>Destination</span>
          <h3 style={{fontFamily:"sans-serif",fontWeight:"bolder"}}>Chitrakote, Bastar</h3>
