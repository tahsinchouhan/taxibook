...
import { FaIdCardAlt, FaPencilAlt ,FaSignInAlt,FaSignOutAlt,FaSuitcaseRolling} from "react-icons/fa";
import { DatePicker, Space } from "antd";
import { API_PATH } from "../../Path/Path";
import moment from 'moment'
import { Card, FormControl, InputGroup, Table,Dropdown } from "react-bootstrap";
...
function BookingProfile() {
    ...
    const common = (bothTickets) =>{
      ...
      if(bothTickets && bothTickets.length){
        bothTickets = bothTickets.sort(function (a, b) {
          return Date.parse(new Date(b.date.split("/").reverse().join("-"))) - Date.parse(new Date(a.date.split("/").reverse().join("-")));
              ...
              <Card.Body>
                ...
                <div className='border-bottom pb-2'>
                  <div className="d-flex">
                    ...
                    <div style={{ fontSize: "12px", fontWeight: "600" }}>Booking</div>
                  </div>
                  </div>
                </Card.Text>
                ...
                <div className='border-bottom pb-2'>
                  <div className="d-flex">
                    ...
                    <div style={{ fontSize: "12px", fontWeight: "600" }}>Login Details</div>
                  </div>
                  </div>
                </Card.Text>
                ...
                <Card.Text>
                  <div className="d-flex">
                    ...
                    <div style={{ fontSize: "12px", fontWeight: "600" }}>Logout</div>
                  </div>
                </Card.Text>
              </Card.Body>
            </Card>
  ...
  <Dropdown.Menu>
    <Dropdown.Item href="#/action-1">on Going</Dropdown.Item>
                  ...
                  {/* <table className="table table-borderedx">
                    <thead>
                      <tr>
                        ...
                        <th scope="col" className="text-center">Booking type</th>
                    ...
                    {bothTickets?.map((item,index)=>{
                      return(
                      <tr>
                        <th scope="row" className="text-center">{item?.booking_Id}</th>
