...
import { getOtp, verifyOtp,signupOtp,signup , loginEmail,verifysignupSuccess} from "../../redux/actions";
            ...
            <Container>
              <Row>
                  ...
                  {flag == 0 ? <div>
                    <Form>
                      ...
                      >
                        ...
                        <span className="mx-1" onClick={emailHandler} style={{ color: "#07bf07",cursor:'pointer' }}>
                          email
                        </span>
                      </div>
                      ...
                      >
                        ...
                        <span className="mx-2" onClick={signupHandler} style={{ color: "#07bf07",cursor:"pointer"}}>
                          Sign Up
                        </span>
                      </p>
                    </Form>
                ...
                <div className="d-flex justify-content-center mb-4">
                      ...
                      >
                        Sign-in with<span> </span>
                        <span className="mx-1" onClick={loginHandler} style={{ color: "#07bf07",cursor:'pointer' }}>
                          Mobile
                        </span>
                      </div>
                      <div className="text-center">
                      ...
                      >
                        Don't have a account?
                        <span onClick={signupHandler} className="mx-2" style={{ color: "#07bf07",cursor:"pointer"}}>
                          Sign Up
                        </span>
                      </p>
                </Form>
                    ...
                    <Form>
                      ...
                      <div className="text-center">
                        <p style={{ fontWeight: "600" }}>
                          Have a account ?
                          <span style={{ color: "#07bf07",cursor:'pointer'}} className="mx-2" onClick={loginHandler}>
                            Login{" "}
                          </span>{" "}
                        </p>
                      </div>
                      ...
                      >
                        ...
                        <div className="mt-4 mb-4 text-center">
                          ...
                          <p className="mt-3" style={{ fontWeight: "600" }}>
                            Don't have a account?
                            <span onClick={signupHandler} className="mx-2" style={{ color: "#07bf07" }}>
                              sign up
                            </span>
                          </p>
                        </div>
