...
function BusMonsoon() {
  ...
  const onClickTrain = (id) => {
    dispatch(setTripData(trips.find((x) => x._id == id)));
          ...
          <Container className="mansoon-div">
            <Row>
              ...
              <Col>
                ...
                >
                  {`${routeData?.startDate?.toLocaleDateString("en-US", {
                    day: "numeric",
                  })} `}
                  {`${routeData?.startDate?.toLocaleDateString("en-US", {
                    month: "short",
                      ...
                      <Row>
                        ...
                        <Col>
                          ...
                          >
                            ...
                            <div
                              className="train-seats d-flex justify-content-center flex-column"
        ...
        <div fluid className="d-md-none">
          ...
          <div>
            {trips?.length > 0
              ? trips?.map((item, i) => (
                  <>
                    <div key={i} onClick={() => onClickTrain(item._id)}>
                      <Container>
                        <Row>
                          <Col>
                            <div
                          ...
                          <Col style={{ float: "right" }}>
                            <Row style={{ float: "right" }}>
                              ...
                              >
                                ...
                                <Col xs={12}>
                                  <div
                                    className="train-seatsmobile  d-flex justify-content-center flex-column"
                                    // onClick={() => onClickTrain(item._id)}
                                  >
                                    <span
                                      style={{
