              ...
              <Card.Body>
                ...
                <div className='border-bottom pb-2'>
                  <div className="d-flex">
                    ...
                    <div onClick={bookingHandler} style={{ fontSize: "12px", fontWeight: "600" }}>Booking</div>
                  </div>
                  </div>
                </Card.Text>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      {profile?.data?.email && profile?.data?.isEmailVerified == false ?
                    <div style={{color:"red"}}> Please Verify your email</div>
                    : <div style={{color:"red"}}>Please Add and Verify Your Email</div>}
                    {profile?.data?.email ? <span style={{marginLeft:'2%'}}>
                        Change Email
                        </span> : null}
                  ...
                  <tr>
                    ...
                    <td>{profile?.data?.mobile}
                    <span className="d-flex justify-content-end email">
                    {profile?.data?.isMobileVerified == false ?
                    <div style={{color:"red"}}> Please Verify your mobile</div>
                    : null}
